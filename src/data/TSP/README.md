...
```bash
uv run python -m src.new_data.TSP.generate \
  --num-instances 1000 \
  --num-nodes 50 \
  --seed 1234 \
  --output-path data/new/tsp50_seed1234.jsonl
```
...
from src.new_data.TSP.dataset import TSPDataset, collate_tsp

dataset = TSPDataset(
    "data/new/tsp50_seed1234.jsonl",
